...
export default function Footer() {
  return (
    <footer className="py-6">
      <div className="text-white container px-6 mx-auto space-y-6 divide-y dark:divide-gray-600 md:space-y-12 divide-opacity-50">
        <div className="grid grid-cols-12">
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
            <NavLink
              ...
              className="flex items-center p-2 justify-center md:justify-start"
            >
              <svg
              ...
              <span className="inline-block text-xl font-bold ml-2">
                TPTvie
              </span>
            </NavLink>
          </div>
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            <p className="pb-4 text-lg font-medium">Dịch vụ</p>
            <ul>
              <li>
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="hover:dark:text-violet-600 text-sm"
                >
                  Xem phim
                </a>
              </li>
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            <p className="pb-4 text-lg font-medium">Chính sách</p>
            <ul>
              <li>
                <a
                  rel="noopener noreferrer"
        ...
        <div className="grid justify-center pt-6 lg:justify-between">
          <div className="flex flex-col self-center text-sm text-center md:block lg:col-start-1 md:space-x-6">
            <span>©2024 Created by Thuy Phuoc Thinh</span>
